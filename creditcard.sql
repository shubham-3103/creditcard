...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3225392483ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=creditcard&table=student">`creditcard`.`student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=creditcard&table=user">`creditcard`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=creditcard&table=transactions">`creditcard`.`transactions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=creditcard&table=admin">`creditcard`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=creditcard&table=store">`creditcard`.`store`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=creditcard&table=USER">`creditcard`.`USER`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=creditcard&table=login">`creditcard`.`login`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="347e757a4638297d69417d67792a3154">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="creditcard" targettable="admin">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="creditcard" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="creditcard" targettable="student">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="creditcard" targettable="store">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `student`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="creditcard" targettable="transactions">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `user` ADD UNIQUE(`USER_EMAIL`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="creditcard" targettable="student">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `student` ADD UNIQUE(`CARD_NUMBER`);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="creditcard" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">show triggers;</span>
                        </div>
